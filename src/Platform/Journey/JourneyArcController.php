...
final class JourneyArcController
{
    ...
    private function page(string $body): string { $message=(string)($_SESSION['flash']??'');unset($_SESSION['flash']);$flash=$message!==''?'<div class="notice">'.self::e($message).'</div>':'';return '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Journey · Koravik</title><link rel="stylesheet" href="/assets/app.css"><link rel="stylesheet" href="/assets/journey.css"></head><body><main id="main" class="page">'.$flash.$body.'</main><footer>Koravik · Invitation without coercion.</footer></body></html>'; }
