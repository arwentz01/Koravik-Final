...
final class WorldProgressController
{
    ...
    {
        $body='<section class="page-heading"><div><p class="eyebrow">World reaction explanation</p><h1>'.self::e($r['title']).'</h1></div></section><section class="surface"><h2>What changed?</h2><p>'.self::e($r['message']).'</p><h2>Why?</h2><p>'.self::e($r['explanation']).'</p><h2>Approved fact received</h2><p>'.self::e($r['received']).'</p><h2>World rule</h2><p>'.self::e($r['rule_key']?:'Epic Ordinary interpreted an approved minimized fact through its current narrative rules.').'</p><h2>Interpreted</h2><p>'.self::e($r['interpreted_at']).'</p><h2>Deliberately excluded</h2><p>'.self::e($r['excluded']).'</p><div class="local-actions"><a class="button" href="/worlds/epic-ordinary/play">Continue story</a><a href="/worlds/epic-ordinary/progress">Back to progress</a></div></section>';
