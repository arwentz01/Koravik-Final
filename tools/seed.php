...
try {
    ...
    $quest = $pdo->prepare(
        'INSERT INTO quests (id, account_id, title, description, status, created_at, updated_at)
         VALUES (:id, :account_id, "Make one corner calmer", "Choose one small space and leave it a little easier to return to.", "active", :created_at, :updated_at)
    ...
    $pdo->commit();
    echo "Seeded Build 001 account, Quest, and Epic Ordinary installation.\n";
